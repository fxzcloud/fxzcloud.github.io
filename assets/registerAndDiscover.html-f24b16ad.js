import{_ as n,V as s,W as a,Z as t}from"./framework-828e3e61.js";const e={},p=t(`<blockquote><p>本文只讨论spring cloud commons中关于服务注册、服务发现的规范定义以及spring cloud alibaba中nacos相应实现。关于nacos client以及 nacos service 中服务注册、发现的实现细节在nacos相关文章中分析。</p></blockquote><h1 id="spring-cloud-服务注册和发现" tabindex="-1"><a class="header-anchor" href="#spring-cloud-服务注册和发现" aria-hidden="true">#</a> spring cloud 服务注册和发现</h1><h2 id="sc-服务注册概述" tabindex="-1"><a class="header-anchor" href="#sc-服务注册概述" aria-hidden="true">#</a> SC 服务注册概述</h2><p>以下都是spring cloud commons定义的服务注册的规范接口。</p><ul><li><p><code>ServiceInstance</code> 表示的是服务发现中的一个实例</p><p>这个接口定义了类似于<code>getHost</code>,<code>getIp</code>获取注册实例host，ip等方法。</p></li><li><p><code>Registration</code>一个标记接口，<code>ServiceRegistry&lt;R&gt;</code>这里面的R泛型就是<code>Registration</code></p><p>是springcloud定义的规范接口。</p></li><li><p><code>ServiceRegistry</code> 服务注册，定义如何向注册中心进行注册，和取消注册</p><p>这个接口定义了<code>register服务注册</code>,<code>deregister服务取消注册</code>等方法，入参是<code>Registration</code>。它是springcloud定义的规范接口。</p></li><li><p>AutoServiceRegistration 标识应用自动进行服务注册的接口，是springcloud定义的规范接口。</p></li></ul><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/**
 * 表示系统中服务的实例。
 *
